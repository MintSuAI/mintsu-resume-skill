...
这是整个 skill 最核心的一步。**左边是大多数人第一次开口的说法，右边是问完之后能写进简历的说法**——事实一个没变，只是被问清楚了：

<p align="center"><img src="assets/before-after.png" width="900"></p>
...
模板里有一个**密度旋钮**，让内容正好铺满一页——半页空白比排版丑更伤，招聘方看到撑不满的一页，第一反应是"这人没什么可写的"：

```css
--fs: 15.5px;   /* 整份简历只调这一个数，字号与所有间距等比缩放 */
                /* 留白多就调大（16.5 / 17），挤到第二页就调小（14.5 / 14）*/
```
